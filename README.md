...
### NVIDIA Tesla T4 (16GB VRAM, Turing `sm_75`)

| Target $X$ | Exact $M(X)$ | CPU Time | GPU Kernel Time | GPU Total Time | Kernel Speedup vs CPU |
| :--- | :--- | :--- | :--- | :--- | :--- |
| $10^{10}$ | $-33,722$ | $0.0289$ s | **$0.0596$ s** | $0.1939$ s | $0.48\times$ |
| $10^{11}$ | $-87,856$ | $0.1300$ s | **$0.1829$ s** | $0.2579$ s | $0.71\times$ |
| $10^{12}$ | $62,366$ | $0.6319$ s | **$0.5799$ s** | $0.9516$ s | **$1.09\times$** |
| $10^{13}$ | $599,582$ | $3.2072$ s | **$1.9655$ s** | $4.0009$ s | **$1.63\times$** |
| $10^{14}$ | $-875,575$ | $14.2579$ s | **$5.9427$ s** | $11.3354$ s | **$2.40\times$** |
| $10^{15}$ | $-3,216,373$ | $94.5594$ s | **$19.9566$ s** | $25.2231$ s | **$4.74\times$** |
