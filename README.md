...
### NVIDIA Tesla T4 (16GB VRAM, Turing `sm_75` - Block-Collaborative Architecture)

| Target $X$ | Exact $M(X)$ | CPU Time (s) | GPU Kernel (s) | GPU Total Time (s) | Kernel Speedup vs CPU | Total Speedup vs CPU |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| $10^{10}$ | $-33,722$ | $0.0276$ | **$0.0092$** | $0.1433$ | **$3.01\times$** | $0.19\times$ |
| $10^{11}$ | $-87,856$ | $0.1286$ | **$0.0287$** | $0.1038$ | **$4.47\times$** | **$1.24\times$** |
| $10^{12}$ | $62,366$ | $0.6124$ | **$0.0788$** | $0.4841$ | **$7.77\times$** | **$1.27\times$** |
| $10^{13}$ | $599,582$ | $3.1251$ | **$0.3634$** | $2.5529$ | **$8.60\times$** | **$1.22\times$** |
| $10^{14}$ | $-875,575$ | $14.0050$ | **$0.8763$** | $7.8991$ | **$15.98\times$** | **$1.77\times$** |
| $10^{15}$ | $-3,216,373$ | $93.5753$ | **$4.3508$** | $11.3548$ | **$21.28\times$** | **$8.24\times$** |
| $10^{16}$ | $-3,195,437$ | $\sim 580$ s | **$41.3200$** | $48.3584$ | **$\sim 14.0\times$** | **$\sim 12.0\times$** |
